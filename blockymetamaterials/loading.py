...
from blockymetamaterials.geometry import DOFsInfo, Geometry
from blockymetamaterials.utils import is_scalar
...
# but now they use the free DOFs directly because DOFsInfo hinders backward compatibility.
def build_loading(
        geometry: Geometry,
